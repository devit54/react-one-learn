    ...
    <footer id="contact" className="bg-gray-900 text-gray-200">
      <div className="container py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-gray-400">
              Khóa học lập trình chất lượng cao với phương pháp dạy 1-1 giúp bạn tiến bộ nhanh chóng.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">React.js</a></li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Giảng Viên</a></li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-3">
                ...
                <span className="text-gray-400">contact@learncode.vn</span>
              </li>
              <li className="flex items-center gap-3">
        ...
        <div className="border-t border-gray-800 mt-12 pt-6 text-center text-gray-400 text-sm">
          <p>&copy; {new Date().getFullYear()} LearnCode. Tất cả quyền được bảo lưu.</p>
        </div>
      </div>
    </footer>
  );
