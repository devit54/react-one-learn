...
import { Lightbulb, Users, Clock, MessageCircle, Globe, Award } from "lucide-react";
  ...
  const features = [
    {
      ...
      description: "Lộ trình học tập được điều chỉnh riêng cho từng học viên dựa trên trình độ và mục tiêu cá nhân."
    },
    {
      icon: <Users className="h-8 w-8 text-brand-blue" />,
      title: "Dạy kèm 1-1",
      description: "Tương tác trực tiếp với giảng viên chuyên nghiệp, giải đáp mọi thắc mắc ngay lập tức."
    },
    {
    ...
    },
    {
      ...
      title: "Dự án thực tế",
      description: "Thực hành với các dự án thực tế, xây dựng portfolio ấn tượng ngay trong khóa học."
    },
    {
      icon: <Award className="h-8 w-8 text-brand-blue" />,
      title: "Chứng chỉ quốc tế",
      description: "Nhận chứng chỉ sau khi hoàn thành khóa học, được công nhận bởi các nhà tuyển dụng."
    }
  ];

  return (
    <section id="features" className="py-16 lg:py-24 bg-brand-gray">
      <div className="container space-y-12">
        <div className="text-center space-y-4 max-w-3xl mx-auto">
          ...
          <p className="text-lg text-muted-foreground">
            Khám phá những lợi ích độc đáo từ phương pháp giảng dạy tập trung vào từng cá nhân
          </p>
        </div>
