            ...
            <div className="container">
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div className="space-y-4">
                  <Badge className="bg-white text-brand-blue mb-2">
                    {course.level}
                  </Badge>
                ...
                <div className="md:col-span-2 space-y-8 order-2 md:order-1">
                    ...
                    <div className="prose max-w-none">
                      <p>
                        {course.longDescription ||
                          "Khóa học được thiết kế để giúp bạn nắm vững các khái niệm từ cơ bản đến nâng cao với phương pháp học 1-1 hiệu quả."}
                      </p>
                      <p>
                        Bạn sẽ được học trực tiếp với giảng viên có kinh nghiệm,
                        thực hành qua các bài tập thực tế và nhận được sự hỗ trợ
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      ...
                      {!course.curriculum && (
                        <p>
                          Chi tiết nội dung khóa học sẽ được cung cấp khi bạn
                          đăng ký khóa học.
                        </p>
                      )}
                    </div>
                  ...
                  <div className="border rounded-lg p-6 md:sticky md:top-24">
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <div>{course.duration || "20 giờ (8 buổi)"}</div>
                      </div>
                      <div>
                        <div className="text-sm text-muted-foreground">
                          Hình thức học
